  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        label: '暴落シナリオ',
        help: '「あり」にすると、FIRE開始（または退職）の翌年に投資資産を一度だけ30%下落させて試算します。取崩期初期の暴落は資産寿命への影響が一番大きい（シーケンスリスク）ため、備えとしてその時期を想定しています。現金資産は対象外、暴落後は通常の利回りで運用を継続（回復）するモデルです。過去の参考: コロナショック（2020）約-34% / リーマンショック（2008）約-38%。30%はそれよりやや軽めの保守想定です。',
        kind: 'toggle',
      },
    ],
  },
